  ...
  return (
    <Router>
      <div>
        ...
        <Menu />
        {notification && <div style={{ border: '1px solid black', padding: 10, marginBottom: 10 }}>{notification}</div>}
        
        <Routes>
          <Route path="/" element={<AnecdoteList anecdotes={anecdotes} />} />
          <Route path="/anecdotes/:id" element={<SingleAnecdote anecdotes={anecdotes} />} />
          <Route path="/create" element={<CreateNewWrapper addNew={addNew} />} />
